...
* Go to the [commit list](https://github.com/m1np3m/m1np3m.github.io/commits/master) (on your repo) to find the last version GitHub built with Jekyll. 
...
* While GitHub Pages prevents server side code from running, client-side scripts are supported.
  * This means that Google Analytics is supported, and [the wiki](https://github.com/m1np3m/m1np3m.github.io/wiki/Adding-Google-Analytics) should contain the most up-to-date information on getting it working.
